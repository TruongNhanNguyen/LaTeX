...
\begin{tikzpicture}[>=latex]
    ...
    c_{21} & |[node style sp,red]| c_{22} & \ldots & c_{2q} \\
    \vdots & \vdots & \ddots & \vdots \\
    c_{n1} & c_{n2} & \ldots & c_{nq} \\
    };

    % note for resultant matrix
    \node [draw,below=10pt] at (C.south) {$C=A\times B$ : \textcolor{red}{$n$ rows}
...
\begin{tikzpicture}[>=latex]
    ...
    \vdots& \ddots & \vdots & \vdots & \vdots \\ b_{k1} &  \ldots& |[node style sp]| b_{kj} & \ldots & b_{kq}  \\
    \vdots& \vdots & \vdots & \ddots & \vdots \\
