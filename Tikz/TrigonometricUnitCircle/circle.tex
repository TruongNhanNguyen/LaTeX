...
\begin{tikzpicture}[scale=3,cap=round]
    ...
    \]
    By the Theorem of Pythagoras we have {\color{coscolor} $\cos^{2}\alpha$} + {\color{sincolor} $\sin^{2}\alpha$}
    = 1. Thus the length of the blue line, which is the {\color{coscolor} cosine of $\alpha$}, must be:
